...
module.exports = {
    register: async (req, res) => {
        const {first_name, last_name, gender, DOBmonth, DOByear, DOBday, address, address2, city, state, zip, phone, email, username, password, cardNumber, expirationMonth, expirationYear, CVV, cardFirstName, cardLastName} = req.body
        ...
        const regMember = await db.addMember(first_name, last_name, gender, DOBmonth, DOByear, DOBday, address, address2, city, state, zip, phone, email, username, hash, cardNumber, expirationMonth, expirationYear, CVV, cardFirstName, cardLastName)
