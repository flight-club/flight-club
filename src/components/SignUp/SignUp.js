...
class SignUp extends Component {
    ...
    render() {
        ...
        <div>
            ...
            <input onChange={this.handleGender} placeholder="gender"/>
            <input onChange={this.handleBirthdate} placeholder="birthdate"/>
            <input onChange={this.handleAddress} placeholder="address"/>
            <input onChange={this.handleAddress2} placeholder="address2"/>
